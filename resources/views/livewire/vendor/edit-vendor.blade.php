<div>
    ...
    <div class="w-3/4 p-4 mt-8 bg-white rounded-lg xl:p-6">
        ...
        <button wire:click="closeEditForm()" class="flex items-center justify-center  px-2 py-2 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-gray-500 rounded-md md:w-auto md:mt-0 hover:bg-gray-400 focus:ring focus:ring-gray-300 focus:ring-opacity-50">
        ...
        <button wire:click="update()" class="flex items-center justify-center  px-2 py-2 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-indigo-500 rounded-md md:w-auto md:mt-0 hover:bg-indigo-400 focus:ring focus:ring-indigo-300 focus:ring-opacity-50">
