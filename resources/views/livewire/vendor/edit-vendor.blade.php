<div>
    ...
    <div class="w-3/4 p-4 mt-8 bg-white rounded-lg xl:p-6">
        ...
        <button wire:click="update()" class="flex items-center justify-center  px-2 py-2 mt-4 text-sm font-medium inline-flex  bg-gradient-to-br from-blue-800 to-yellow-500 font-medium  justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white  focus:outline-none focus:ring-2">
