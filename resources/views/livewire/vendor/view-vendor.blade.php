            ...
            {{-- <div class="bg-white shadow-lg shadow-gray-200 rounded-2xl p-4 ">
                ...
                <div action="#">
                    <div class="grid grid-cols-1 gap-6 mb-6 sm:grid-cols-2">
                        <div>
                            <label for="full-name" class="block mb-2 text-sm font-medium text-gray-900">(Full name as
                        ...
                        <div>
                            <label for="last-name" class="block mb-2 text-sm font-medium text-gray-900">Card Number
                                *</label>
                        ...
                        <div>
                            <label for="zip-code" class="block mb-2 text-sm font-medium text-gray-900">Postal / ZIP
                                code
                                (optional)</label>
    ...
    <div class="w-3/4  ">
        ...
        <div class="flex flex-col my-6 mx-4  bg-white  rounded-2xl shadow-xl shadow-gray-200">
            <div class="flex justify-between mx-4  ">
                ...
                <div class="relative">
                    <svg wire:click="enableEditing" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 table-fixed">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap lg:p-5"> 20,000 /
                                    </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap lg:p-5">#194556
                                    </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap lg:p-5"> 22- july </td>
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap lg:p-5"> 20,000.00 Tzs
                                    </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap lg:p-5">#194556
                                    </td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap lg:p-5"> 22- july </td>
        ...
        <div class="max-w-lg mt-6  mx-auto bg-white rounded-lg shadow-md p-6">
            ...
            <div   class="space-y-4">
              ...
              <div>
                ...
                <input type="number" id="amount" name="amount" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Enter Amount">
              </div>

              <!-- Submit Button -->
              <div>
                <button type="submit" class="w-full inline-flex  bg-gradient-to-br from-blue-800 to-yellow-500 font-medium  justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white  focus:outline-none focus:ring-2    ">
                  Apply Filters
                </button>
              </div>
            </form>
